                    ...
                    <div class="bg-[#fafafa] shadow-sm border border-[#f0ecece2] rounded-2xl py-4 p-8 space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-3">
                                <p>Nama Pemesan</p>
                                <div>
                                    <PartialsInputFloating :statFloat="false" id="name" name="name" placeholder="Nama Pemesan"></PartialsInputFloating>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    <PartialsInputFloating :statFloat="false" id="no_hp" name="no_hp" placeholder="Email Pemesan"></PartialsInputFloating>
                            ...
                            <div class="space-y-3">
                                <p>Email Pemesan</p>
                                <div>
                                    <PartialsInputFloating :statFloat="false" id="email" name="email" placeholder="Email Pemesan"></PartialsInputFloating>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-3" v-for="(_, i) in parseInt(data.jumlah_penumpang)" :key="i">
